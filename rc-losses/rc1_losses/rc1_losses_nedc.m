...
load('rc1_cf_fmincon_params.mat');
load('nedc.mat');
I = I + 1e-4;
...
title('RC1 - NEDC')
legend('RC1', 'No RC2', 'Physical', 'location', 'northeast')
...
xlabel('Time [s]')
ylabel('Loss [W]')
title('Losses in RC1 and Physical Model - NEDC')
legend('RC1', 'Physical', 'location', 'northwest')